  ...
  describe('/show-get-params', () => {
    it('GET /show-get-params should have URL Query parameters', (done) => {
      ...
      .end((err, res) => {
        ...
        res.should.have.status(200)
        res.req.res.body.foo.should.exist // eslint-disable-line
  ...
  describe('/info', () => {
    it('GET /info should be JSON', (done) => {
      ...
      .end((err, res) => {
        ...
        res.should.have.header('content-type', 'application/json; charset=utf-8')
        res.should.have.status(200)
        res.req.res.body.should.exist // eslint-disable-line
    ...
    it('GET /info?interfaces=1 should include network interface(s) information', (done) => {
      ...
      .end((err, res) => {
        ...
        res.should.have.header('content-type', 'application/json; charset=utf-8')
        res.should.have.status(200)
        res.req.res.body.network.should.exist // eslint-disable-line
        res.req.res.body.network.interfaces.should.exist // eslint-disable-line
    ...
    it('GET /info?environment=1 should include environment information', (done) => {
      ...
      .end((err, res) => {
        ...
        res.should.have.header('content-type', 'application/json; charset=utf-8')
        res.should.have.status(200)
        res.req.res.body.environment.should.exist // eslint-disable-line
